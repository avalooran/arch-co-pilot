...
class StoreEmbeddings(PGVectorInterface):
    ...
    def main_embedding(self):
        ...
        chunk_embedings_df1 = self.pd_embed_doc(self.accumulated_chunks, embbeding_type,tabled_dtls['df_cols'])
        chunk_embedings_df1 = chunk_embedings_df1.loc[chunk_embedings_df1.astype(str).drop_duplicates().index]
